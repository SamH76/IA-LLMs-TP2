package ht.mbds.samanthaHenry.outil.meteo;
...
//            System.out.println("Réponse de l'API météo : " + response);
    ...
    @Tool("""
    Retourne un tableau de doubles contenant la latitude (index 0) et la longitude (index 1) d'une ville donnée.
    Si plusieurs villes portent le même nom, la méthode renvoie la première correspondance trouvée.
    """)
    public double[] getCoordonnees(@P("Ville") String ville) {
        try {
